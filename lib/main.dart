    ...
    if(Platform.isAndroid) {
      try{
        ...
        await Firebase.initializeApp(
          name: 'com.joypara.user',
          options: const FirebaseOptions(
            apiKey: "AIzaSyATwEjRnBB2UMMGHva7KX5YtmNCJfOazC0",
            projectId: "joypara-user-app",
            messagingSenderId: "761937600950",
            appId: "1:761937600950:android:19ac3436343f5c6393a117"
          )
        );
      } finally {
        await Firebase.initializeApp();
